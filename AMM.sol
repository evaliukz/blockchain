...
contract AMM is AccessControl{
	...
	*/
	...
	/*
        ...
        sell_token should match either tokenA_addr or tokenB_addr, and 
        sell_quantity should be the amount of that token being traded to the contract. 
        The contract should calculate the amount of the other token to return to the sender 
        using the invariant calculation of Uniswap.
	*/
