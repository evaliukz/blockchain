...
def send_tokens( receiver_pk, tx_amount ):
    ...
    mnemonic_secret = "wait morning kitten dog horse wind storm cat cat amazing dress utility school campus cute abstract thought sense fruit weather ability working apple fun health"
